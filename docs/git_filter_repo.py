...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/code-view.8db393ebb1f93303.module.css" />
  ...
  <title>git-filter-repo/git_filter_repo.py at main · newren/git-filter-repo</title>
  ...
  <meta name="fetch-nonce" content="v2:ebcad7ab-c7ef-d0b4-8b79-508a901f2285">

    
  <meta name="current-catalog-service-hash" content="f3abb0cc802f3d7b95fc8762b94bdcb13bf39634c40c357301c4aa1d67a256fb">


  <meta name="request-id" content="D747:10CAD2:222A9B2:270597D:6A3503C7" data-turbo-transient="true" /><meta name="html-safe-nonce" content="6e0606de9ba025ebae4f9520881574d2bf9453faf9b5ea41f8447591a14dc0bf" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="aa8f029f92a0772a628ab8e595925029c64a2a14b893acf7684a273f5f696dc8" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="196770966" /><meta name="octolytics-actor-login" content="aldosachs" /><meta name="octolytics-actor-hash" content="8a9a1d6ba43783454d51cd062059d7fc2f1c5e53041f5d33d14c36404eaafd3f" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="user-login" content="aldosachs">
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Quickly rewrite git repository history (filter-branch replacement) - git-filter-repo/git_filter_repo.py at main · newren/git-filter-repo">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/newren/git-filter-repo/blob/main/git_filter_repo.py" />

      <meta name="twitter:image" content="https://opengraph.githubassets.com/37d1a52c67a036794892027198ee65d72461dabf457760e7cf0169d7cc381a07/newren/git-filter-repo" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="git-filter-repo/git_filter_repo.py at main · newren/git-filter-repo" /><meta name="twitter:description" content="Quickly rewrite git repository history (filter-branch replacement) - newren/git-filter-repo" />
  <meta property="og:image" content="https://opengraph.githubassets.com/37d1a52c67a036794892027198ee65d72461dabf457760e7cf0169d7cc381a07/newren/git-filter-repo" /><meta property="og:image:alt" content="Quickly rewrite git repository history (filter-branch replacement) - newren/git-filter-repo" /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="git-filter-repo/git_filter_repo.py at main · newren/git-filter-repo" /><meta property="og:url" content="https://github.com/newren/git-filter-repo/blob/main/git_filter_repo.py" /><meta property="og:description" content="Quickly rewrite git repository history (filter-branch replacement) - newren/git-filter-repo" />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/196770966/ws?session=eyJ2IjoiVjMiLCJ1IjoxOTY3NzA5NjYsInMiOjIxNTIzMTUwNDksImMiOjM1MjEwMjQ2LCJ0IjoxNzgxODU5Mjk1fQ==--91b62ae3bca75676cbafb605232d93572d38eceec2fa7b5bbfc2dd7cd38d8f75" data-refresh-url="/_alive" data-session-id="a3e8b1e7fd9cbe1c0de351eac21b1902952ce304a809119db0e4d8a196857b75">
      <link rel="shared-web-socket-src" href="/assets-cdn/worker/socket-worker-310827049a9185cc.js">

      <link rel="service-worker-src" href="/assets-cdn/worker/service-worker-4c157845901c5366.js?current_user=aldosachs&amp;errors_url=https%3A%2F%2Fapi.github.com%2F_private%2Fbrowser%2Ferrors&amp;release=5a237db232ac7eb848385a938e8efefff8aaed05&amp;actor_id=196770966&amp;is_staff=false&amp;analytics_collector_url=https%3A%2F%2Fcollector.github.com%2Fgithub%2Fcollect">
  ...
  <meta name="current-repo-nwo" content="newren/git-filter-repo" />
...
<qbsearch-input class="search-input" data-scope="repo:newren/git-filter-repo" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="Nl40kuU6N8gR7ZaEFKpXKi5D7gRIDgthVYVf0ame5AMvkB0Wk5X787mGEvRnaKvJqrSPZYM2WdSaEN5bXKBThw" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="newren/git-filter-repo" data-current-org="" data-current-owner="newren" data-logged-in="true" data-copilot-chat-enabled="true" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-254fec35-0895-43b5-9f07-b3baf2a2b38a" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-254fec35-0895-43b5-9f07-b3baf2a2b38a" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="ycB5x_ajr_27zNxfo97ydpVN3-3LwjPRgyyR5xTAgHUm0bDSZ9kf7COKK4V1pbHwrHjEiD2Zh_jXRXRDm21THQ" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="eCqWOZCzAWg50Eaz20zk87ppnUBpGd_62ZUxDCe9qzEk6_V9HcdsFEgZ_9GO6ovoOGmrx8R69TXQdtsAXVOwLA" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="3wqZVof4ZxpeZlMw19CT5fYSLSN2MUuOvAZRz-ZW5S8go3ltYEJ2tU-UuQWlGSY63BPCTfpK9zOVkBtzHHxDHg" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input>  <input type="hidden" value="_jRuhQs7vayua7WiG61WTnabVI4tpt96KyimfBLnu7n4PooyFMkLccNUuoAdf3ycWyYn1bKkDfEVcBtaLjVXNg" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
    ...
    <button id="icon-button-cb773625-ab37-4278-b4b9-d8ac156e25ea" aria-labelledby="tooltip-9b79c044-3d09-40e0-b1fb-416d5bf2f6ff" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" data-component="Octicon" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-9b79c044-3d09-40e0-b1fb-416d5bf2f6ff" for="icon-button-cb773625-ab37-4278-b4b9-d8ac156e25ea" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTk2NzcwOTY2IiwidCI6MTc4MTg1OTI5NX0=--312108e7d602201bd66c15649f9c0e24ed59d45dbbb71180a551ddc58459a894" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<turbo-frame id="repo-content-turbo-frame" target="_top" data-turbo-action="advance" class="">
  ...
  <a href="https://github.dev/" class="d-none js-github-dev-new-tab-shortcut" data-hotkey="Shift+&gt;" target="_blank" rel="noopener noreferrer">Open in a new github.dev tab</a>
    <a class="d-none" data-hotkey=",,Mod+Alt+," target="_blank" href="/codespaces/new/newren/git-filter-repo/tree/main?resume=1">Open in codespace</a>
...
<react-app
  app-name="code-view"
  initial-path="/newren/git-filter-repo/blob/main/git_filter_repo.py"
...
<template id="snippet-clipboard-copy-button-unpositioned">
  <div class="zeroclipboard-container">
    ...
    <style>
      ...
      .user-mention[href$="/aldosachs"]:before,
      .user-mention[href$="/aldosachs"]:after {
        content: '';
